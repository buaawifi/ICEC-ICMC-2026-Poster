...
\setbeamerfont{block title}{family=\rmfamily,size=\fontsize{26.0}{30.0}\selectfont,series=\bfseries}
...
\setlength{\introvisualheight}{25.0cm}
...
\centering
\includegraphics[width=\linewidth,height=12.3cm,keepaspectratio]{assets/membrane_type_storage_tank.png}
\introcaption{Membrane-type LH$_2$ storage-tank concept and layered containment barrier.}

\vfill
\includegraphics[width=\linewidth,height=7.8cm,keepaspectratio]{assets/membrane.png}
\introcaption{Corrugated membrane geometry used to absorb restrained in-plane contraction.}
\end{minipage}
\end{column}
\hfill
...
\begin{minipage}[t][\introvisualheight][s]{\linewidth}
\centering
\resizebox{0.96\linewidth}{!}{\input{assets/validation_route.tex}}
\vfill
\introcaption{Staged validation route linking room-temperature mechanism tests to LN$_2$ cycling and future LH$_2$ qualification.}
\end{minipage}
\end{column}
\end{columns}
...
%\end{tikzpicture}}
%\end{center}
%{\fontsize{13.8}{16.2}\selectfont\color{black!64}Conceptual schematic: cool-down contraction creates the primary-layer displacement demand; corrugations absorb the demand by geometric compliance; room-temperature DIC and AE tests screen strain redistribution and damage evolution before LN$_2$ cycling plus pressure-retention checks verify pilot-membrane integrity.\par}
\endgroup
\end{posterblock}

% Non-Introduction content is temporarily commented out.
% --- Non-Introduction content commented out: begin ---
...
%\end{posterblock}
% --- Non-Introduction content commented out: end ---
