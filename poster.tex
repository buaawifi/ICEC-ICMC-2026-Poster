...
\begin{tikzpicture}[
  font=\rmfamily,
  flow/.style={-{Latex[length=3.2mm]},line width=1.05pt,draw=black!55},
  load/.style={-{Latex[length=2.8mm]},line width=1.0pt,draw=smured!82},
  evidence/.style={rounded corners=3pt,line width=0.75pt,minimum width=4.1cm,minimum height=0.68cm,align=center,font=\bfseries\scriptsize}
]
\node[font=\bfseries\normalsize,text=smunavy,align=center] at (0,1.72) {Cool-down};
\node[font=\bfseries\normalsize,text=smugold!75!black,align=center] at (7.6,1.72) {Corrugation};
\node[font=\bfseries\normalsize,text=smucyan!70!black,align=center] at (15.2,1.72) {Checks};

\draw[line width=1.05pt,draw=smunavy!72,fill=smublue!4,rounded corners=2pt] (-2.25,-0.45) rectangle (2.25,0.55);
\draw[line width=1.35pt,draw=smunavy] (-1.82,0.05) -- (1.82,0.05);
\draw[load] (-2.85,0.05) -- (-2.02,0.05);
\draw[load] (2.85,0.05) -- (2.02,0.05);
\node[font=\scriptsize,text=smured!82!black] at (0,0.92) {primary barrier};
\node[font=\scriptsize,align=center,text=black!72] at (0,-1.08) {in-plane displacement\\from cool-down};

\draw[flow] (3.05,0.05) -- (4.52,0.05);

\draw[line width=1.55pt,draw=smunavy]
  (5.25,0.05)
  .. controls (5.70,0.90) and (6.25,0.90) .. (6.70,0.05)
  .. controls (7.15,-0.80) and (7.70,-0.80) .. (8.15,0.05)
  .. controls (8.60,0.90) and (9.15,0.90) .. (9.60,0.05);
\draw[dashed,line width=0.75pt,draw=black!35] (5.25,0.05) -- (9.60,0.05);
\draw[load,draw=smugold!88!black] (6.10,1.07) arc[start angle=140,end angle=35,radius=0.55cm];
\draw[load,draw=smugold!88!black] (8.80,-0.97) arc[start angle=-45,end angle=-145,radius=0.55cm];
\node[font=\scriptsize,align=center,text=black!72] at (7.6,-1.08) {bending/rotation lowers\\sheet stretching demand};

\draw[flow] (10.45,0.05) -- (11.92,0.05);

\node[evidence,draw=smublue,fill=smublue!9] at (15.2,0.82) {DIC/PLC strain field};
\node[evidence,draw=smured,fill=smured!8] at (15.2,0.05) {AE cyclic activity};
\node[evidence,draw=smucyan,fill=smucyan!8] at (15.2,-0.72) {Pressure-retention test};
\node[font=\scriptsize,align=center,text=black!72] at (15.2,-1.55) {assembly integrity};
\end{tikzpicture}}
\end{center}
